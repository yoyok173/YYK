...
creator=["udc7ce8646bbe9a2c6b32ff4d0ba586e1","u74927467b80b399ca6e5c9082dd910b9"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/",
    "lang":"JP",
    "comment":"Owner : line://ti/p/",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
              ...
              if msg.from_ in admin:
				...
				if msg.from_ in admin:
					if wait["clock"] == True:
						...
						cl.sendText(msg.to,"Jamnya dinyalain dulu kk!")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Iya kk aku disini")
					ki.sendText(msg.to,"Aku juga ^_^")
					kk.sendText(msg.to,"Aku juga dong")
					kc.sendText(msg.to,"Aku juga lohhô€œô€…”Har Harô¿¿")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line://ti/p/")
						print "DiLike"
					except:
							pass
				else:
