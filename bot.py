...
i͓̽{•--» p͓̽r͓̽o͓̽t͓̽e͓̽c͓̽t͓̽ c͓̽o͓̽m͓̽m͓̽a͓̽n͓̽d͓̽ «--•}i͓̽
☫[Protect 「On/Off」]
☫[Qr 「On/Off」]
☫[Cancel 「On/Off」]
☫[Invite 「On/Off」] 
...
i͓̽{•--» a͓̽u͓̽t͓̽o͓̽ c͓̽o͓̽m͓̽m͓̽a͓̽n͓̽d͓̽ «--•}i͓̽
☫[Auto add 「On/Off」]
☫[Auto cancel 「On/Off」]
☫[Auto leave 「On/Off」]
☫[Auto join 「On/Off」]
...
#--------------------------------------------------------
                ...
                ki10.sendText(msg.to,"􂤁􀆋down􏿿􂤁􀆋down􏿿􂤁􀆋down􏿿􂤁����down􏿿􂤁􀆋down􏿿􂤁􀆋down􏿿􂤁􀆋down􏿿")
                ki10.sendMessage(msg)
                ki10.sendText(msg.to,"􂤁􀆊up􏿿􂤁􀆊up􏿿􂤁􀆊up������􂤁􀆊up􏿿􂤁􀆊up􏿿􂤁􀆊up􏿿􂤁􀆊up􏿿")
...
#-----------------------------------------------------------
                ...
                profile = ki.getProfile()
                text = profile.displayName + " Hadir bro􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿"
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.sendText(msg.to,"􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿 Byee Bye "  +  str(ginfo.name)  + "")
...
#-----------------------------------------------TAG ALL-----------------------------------------------#
				...
				if msg.from_ in admin:
					...
					ki10.sendText(msg.to,"Sudah jangan berantem kakak ┑(￣▽￣)┍")
...
#			    random.choice(KAK).kickoutFromGroup(op.param1,[op.param2])
	...
	if op.type == 11:
        ...
        if op.type == 15:
            ...
            random.choice(KAC).sendText(op.param1, "Jangan balik lagi (づ￣ ³￣)づ")               
